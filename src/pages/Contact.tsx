...
const Contact = () => {
  ...
  useEffect(() => {
    ...
    fallbackImg.src = "https://images.unsplash.com/photo-1469474968028-56623f02e42e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80";
    fallbackImg.onload = () => setFallbackLoaded(true);
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[400px] overflow-hidden">
        {!imageLoaded && !imageError && (
          <div className="absolute inset-0 bg-gradient-to-r from-sit-red/20 to-sit-dark/20 animate-pulse" />
        )}
        ...
        {imageError ? (
          <>
            {fallbackLoaded ? (
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-sit-red to-sit-dark flex items-center justify-center">
              ...
              >
                ...
                <div className="space-y-6 md:space-y-8">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-medium text-sit-dark mb-1">Customer Service</h3>
                      <p className="text-sit-dark/70 text-justify">
                        Available 24/7 to assist you with any travel-related queries. Our dedicated support team ensures a smooth travel experience from planning to execution and beyond.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sit-dark/70">
                        <a href="tel:+91-8178840574" className="hover:text-sit-red transition-colors">
                          +91-8178840574
                        </a>
                      </p>
                    </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sit-dark/70">
                        <a href="mailto:southinternationaltravels@gmail.com" className="hover:text-sit-red transition-colors">
