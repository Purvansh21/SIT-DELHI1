          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
              <div className="text-center md:text-left">
                ...
                <h4 className="font-semibold mb-2 text-sm md:text-base">SIT Ghaziabad</h4>
              ...
              <div className="text-center md:text-left">
                <h4 className="font-semibold mb-2 text-sm md:text-base">SIT Mahabaleshwar</h4>
                <p className="text-xs md:text-sm text-gray-400 mb-4">
                  Shop 201, Beside Ganesh Medical, Murray Peth, Mahabaleshwar, Maharashtra – 412806
                </p>
                
                <h4 className="font-semibold mb-2 text-sm md:text-base">SIT Latur</h4>
                <p className="text-xs md:text-sm text-gray-400">
