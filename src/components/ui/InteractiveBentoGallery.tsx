    ...
    return (
        <>
            <motion.div
                ...
                className="fixed inset-0 w-full min-h-screen sm:h-[95vh] md:h-[650px] backdrop-blur-lg 
                ...
                <div className="h-full flex flex-col">
                    <div className="flex-1 p-2 sm:p-3 md:p-4 flex items-center justify-center bg-gray-50/50">
                        <AnimatePresence mode="wait">
                            <motion.div
                                key={selectedItem.id}
                                className="relative w-full aspect-[16/10] max-w-[95%] sm:max-w-[90%] md:max-w-4xl 
                                         h-auto max-h-[80vh] rounded-lg overflow-hidden shadow-md"
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-3 sm:p-4 md:p-5 
                                    ...
                                    <div className="flex items-start sm:items-center justify-between">
                                        <div className="flex-1 pr-3">
                                            ...
                                            <p className="text-white/90 text-xs sm:text-sm md:text-base mt-2 line-clamp-3 sm:line-clamp-none">
                                                {selectedItem.desc}
                                            </p>
                                        </div>
                                        <motion.button
                                            className="flex items-center justify-center p-2 sm:p-2.5 md:p-3 
        ...
        <div className="container mx-auto px-4 py-12 md:py-16 max-w-6xl">
            ...
            <AnimatePresence mode="wait">
                {selectedItem ? (
                    ...
                    <motion.div
                        className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-4 md:gap-5 auto-rows-[100px]"
                        initial="hidden"
                        animate="visible"
                        exit="hidden"
                        variants={{
